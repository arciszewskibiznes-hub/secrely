        ...
        <div className="flex items-center gap-3 px-4 pt-4 pb-3">
          ...
          <div className="flex-1 min-w-0">
            <Link href={`/creator/${post.creator.username}`} className="flex items-center gap-1.5">
              <span className="text-sm font-semibold text-foreground hover:text-[hsl(270,75%,60%)] transition-colors truncate">
          ...
          <div className="relative aspect-[4/3] bg-secondary overflow-hidden">
            <Image
              ...
              className={cn(
                ...
                post.isLocked && !unlocked && "locked-blur"
              )}
            ...
            {post.isLocked && !unlocked && (
              <div className="absolute inset-0 locked-overlay flex flex-col items-center justify-center gap-3 px-6">
                ...
                <div className="text-center">
                  <p className="text-sm font-semibold text-foreground">Premium Content</p>
                  <p className="text-xs text-muted-foreground mt-0.5">Unlock for {post.price} credits</p>
                </div>
                <Button
                  variant="purple"
                  size="sm"
