    ...
    >
      <div className="card-base p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground">Sign in to your Secrely account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-end">
            <button type="button" className="text-xs text-[hsl(270,75%,60%)] hover:underline font-medium">
              Forgot password?
            </button>
          </div>
