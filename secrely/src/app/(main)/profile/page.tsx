...
const tabs = [
  { id: "posts", label: "Saved", icon: Grid },
  { id: "unlocked", label: "Unlocked", icon: Lock },
      ...
      >
        ...
        <div className="px-5 pb-5">
          ...
          <div className="space-y-1">
            ...
            {user.bio && (
              <p className="text-sm text-foreground leading-relaxed pt-1">{user.bio}</p>
            )}
          </div>
          ...
          <div className="grid grid-cols-4 gap-2 mt-4 pt-4 border-t border-border">
            {[
              { label: "Credits", value: formatCredits(balance) },
              { label: "Unlocked", value: unlockedPostIds.length },
              { label: "Following", value: subscriptions.length },
              { label: "Liked", value: formatNumber(47) },
            ].map(({ label, value }) => (
          ...
          {subscriptions.length > 0 && (
            <div className="mt-4 pt-4 border-t border-border">
              <div className="text-xs text-muted-foreground mb-2">Following creators</div>
      ...
      {displayPosts.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            {activeTab === "unlocked"
              ? "Unlock premium posts to see them here"
              : activeTab === "liked"
